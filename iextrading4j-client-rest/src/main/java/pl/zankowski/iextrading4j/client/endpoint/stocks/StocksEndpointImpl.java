...
public class StocksEndpointImpl implements StocksEndpoint {
    ...
    public Quote requestQuote(StockRequest stockRequest) {
        ...
        webTarget = PathUtil.appendPaths(webTarget, STOCK_PATH, stockRequest.getSymbol(), QUOTE_PATH);
    ...
    public Chart[] requestChart(ChartRequest chartRequest) {
        WebTarget webTarget = restClient.target(baseApiUrl);
        webTarget = PathUtil.appendPaths(webTarget, STOCK_PATH, chartRequest.getSymbol(), CHART_PATH, chartRequest.getChartRange().getCode());
    ...
    public Company requestCompany(StockRequest stockRequest) {
        WebTarget webTarget = restClient.target(baseApiUrl);
        webTarget = PathUtil.appendPaths(webTarget, STOCK_PATH, stockRequest.getSymbol(), COMPANY_PATH);
    ...
    public KeyStats requestKeyStats(StockRequest stockRequest) {
        WebTarget webTarget = restClient.target(baseApiUrl);
        webTarget = PathUtil.appendPaths(webTarget, STOCK_PATH, stockRequest.getSymbol(), KEY_STATS_PATH);
    ...
    public News[] requestNews(NewsRequest newsRequest) {
        WebTarget webTarget = restClient.target(baseApiUrl);
        webTarget = PathUtil.appendPaths(webTarget, STOCK_PATH, newsRequest.getSymbol(), NEWS_PATH, NEWS_RANGE_PATH, String.valueOf(newsRequest.getRange()));
    ...
    public Financials requestFinancials(StockRequest stockRequest) {
        WebTarget webTarget = restClient.target(baseApiUrl);
        webTarget = PathUtil.appendPaths(webTarget, STOCK_PATH, stockRequest.getSymbol(), FINANCIALS_PATH);
    ...
    public Earnings requestEarnings(StockRequest stockRequest) {
        WebTarget webTarget = restClient.target(baseApiUrl);
        webTarget = PathUtil.appendPaths(webTarget, STOCK_PATH, stockRequest.getSymbol(), EARNINGS);
    ...
    public Logo requestLogo(StockRequest stockRequest) {
        WebTarget webTarget = restClient.target(baseApiUrl);
        webTarget = PathUtil.appendPaths(webTarget, STOCK_PATH, stockRequest.getSymbol(), LOGO_PATH);
    ...
    public double requestPrice(StockRequest stockRequest) {
        WebTarget webTarget = restClient.target(baseApiUrl);
        webTarget = PathUtil.appendPaths(webTarget, STOCK_PATH, stockRequest.getSymbol(), PRICE_PATH);
    ...
    public DelayedQuote requestDelayedQuote(StockRequest stockRequest) {
        WebTarget webTarget = restClient.target(baseApiUrl);
        webTarget = PathUtil.appendPaths(webTarget, STOCK_PATH, stockRequest.getSymbol(), DELAYED_QUOTE_PATH);
