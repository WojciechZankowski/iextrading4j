...
public class OtcSymbolsRequestBuilder extends AbstractRequestFilterBuilder<List<ExchangeSymbol>, OtcSymbolsRequestBuilder>
    ...
    public RestRequest<List<ExchangeSymbol>> build() {
        return RestRequestBuilder.<List<ExchangeSymbol>>builder()
                .withPath("/ref-data/otc/symbols").get()
